...
#             filename2 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}TestninputST.pt".format(s)
#             torch.save(inputSpT, filename2)
#             refST = {refSpikeTrain}
#             filename4 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}TestnrefST.pt".format(s)
#             torch.save(refST, filename4)
#             outputSpikeTrain_dict[s] = refSpikeTrain
            filename1 = "/home/vaishnavi/multiple_opt/rmsprop/nPair{}Testinitweights.pt".format(s)
...
#             filename1 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}Testinitweights1.pt".format(s)
...
#                         
                        ssd += torch.abs(torch.sqrt(up_w**2))
                        if ssd.any() != 0:
                            lr =  mu/(1e-8+ssd)
                        else: 
                            lr = mu
...
#                         filename100 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}Testnweights_updates.pt".format(s)
#                         torch.save(synaptic_wt_list,filename100)
#                 print(synaptic_wt_list[w])           
#                 filename1 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}Testnweights.pt".format(s)
#                 weightup_dict = {}
#                 weightupdate_list.append(synaptic_wt_list[w])
#                 weightup_dict[w] = weightupdate_list
#                 torch.save(weightupdate_list,filename1)
#                 filename2 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}Testnerror.pt".format(s)
#                 error_dict = {}
...
#         filename2 = "/home/vaishnavi/multiple_opt/adagrad/nPair{}Testnmu.pt".format(s)
