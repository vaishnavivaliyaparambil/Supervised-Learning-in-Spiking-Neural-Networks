...
#             filename2 = "/home/vaishnavi/multiple_opt/adam/nPair{}TestninputST.pt".format(s)
#             torch.save(inputSpT, filename2)
#             refST = {refSpikeTrain}
#             filename4 = "/home/vaishnavi/multiple_opt/adam/nPair{}TestnrefST.pt".format(s)
#             torch.save(refST, filename4)
#             outputSpikeTrain_dict[s] = refSpikeTrain
            filename1 = "/home/vaishnavi/multiple_opt/adam/nPair{}Testnweights5.pt".format(s)
...
#             filename1 = "/home/vaishnavi/multiple_opt/adam/nPair{}Testinitweights1.pt".format(s)
...
#                         upw_expand2[0,:,:] = upw_expand
                        ...
                        beta2=0.999
                        epsilon=1e-8
                        m0 = beta1*m0+(1-beta1)*(ddd)
                        v0 = beta2*v0+(1-beta2)*(ssd**2)
                        mcap = m0/(1-beta1)
                        vcap = v0/(1-beta2)
                        update = ((lr*mcap)/(torch.sqrt(vcap)+epsilon)).T
                        update_mat = torch.zeros(1,15,1000)
                        for r in range(1000):
                            update_mat[:,:,r] = update
                        interWeightsupdate = interWeightsmod - update_mat
#                         sns.heatmap(update_tens_cap[0,:,:].detach().cpu().numpy())
#                         plt.title('Update_Tensor(Capped)')
#                         plt.show()
...
#                         filename100 = "/home/vaishnavi/multiple_opt/adam/nPair{}Testnweights_updates6.pt".format(s)
#                         torch.save(synaptic_wt_list,filename100)
#                 print(synaptic_wt_list[w])           
#                 filename1 = "/home/vaishnavi/multiple_opt/adam/nPair{}Testnweights6.pt".format(s)
#                 weightup_dict = {}
#                 weightupdate_list.append(synaptic_wt_list[-1])
#                 weightup_dict[w] = weightupdate_list
#                 torch.save(weightupdate_list,filename1)
#                 filename2 = "/home/vaishnavi/multiple_opt/adam/nPair{}Testnerror6.pt".format(s)
#                 error_dict = {}
...
#         filename2 = "/home/vaishnavi/multiple_opt/adam/nPair{}Testnmu6.pt".format(s)
