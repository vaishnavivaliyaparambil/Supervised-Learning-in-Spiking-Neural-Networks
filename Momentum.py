...
#             filename2 = "/home/vaishnavi/multiple_opt/momentum/nPair{}TestninputST.pt".format(s)
#             torch.save(inputSpT, filename2)
#             refST = {refSpikeTrain}
#             filename4 = "/home/vaishnavi/multiple_opt/momentum/nPair{}TestnrefST.pt".format(s)
#             torch.save(refST, filename4)
#             outputSpikeTrain_dict[s] = refSpikeTrain
            filename1 = "/home/vaishnavi/multiple_opt/momentum/nPair20Testnweights.pt".format(s)
...
#             filename1 = "/home/vaishnavi/multiple_opt/momentum/nPair{}Testinitweights1.pt".format(s)
...
#                         upw_expand2[0,:,:] = upw_expand
                        ssd = beta*ssd+torch.abs(up_w)
                        update = (mu*ssd).T
#                         print(update.shape)
                        update_mat = torch.zeros(1,15,1000)
                        for r in range(1000):
                            update_mat[:,:,r] = update
#                         print('update_mat',torch.nonzero(update_mat))
...
#                         print(synaptic_wt_list)
#                         interWeightsupdate[:,:,:] = last_weight.t()
                        filename100 = "/home/vaishnavi/multiple_opt/momentum/nPair{}Testnweights_updates2.pt".format(s)
                        torch.save(synaptic_wt_list,filename100)           
                filename1 = "/home/vaishnavi/multiple_opt/momentum/nPair{}Testnweights2.pt".format(s)
                weightup_dict = {}
                weightupdate_list.append(synaptic_wt_list[-1])
                weightup_dict[w] = weightupdate_list
                torch.save(weightupdate_list,filename1)
                filename2 = "/home/vaishnavi/multiple_opt/momentum/nPair{}Testnerror.pt".format(s)
                error_dict = {}
        ...
        filename2 = "/home/vaishnavi/multiple_opt/momentum/nPair{}Testnmu.pt".format(s)
...
import torch as torch
filename = "/home/vaishnavi/multiple_opt/adagrad/nPair20Testnweights2.pt"
